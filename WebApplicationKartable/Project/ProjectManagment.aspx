<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ProjectManagment.aspx.cs" Inherits="WebApplicationKartable.ProjectManagment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align:center;"><h2>مدیریت نمایشگاه</h2></div>
    ...
    <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="14"  OnPageIndexChanging="grid_PageIndexChanging" 
     OnSelectedIndexChanging="CustomersGridView_SelectedIndexChanging" GridLines="Horizontal" Width="600" Height="500">
        ...
        <asp:BoundField HeaderText="نام نمایشگاه" DataField="project_name" >
         ...
         <asp:BoundField HeaderText="کد نمایشگاه" DataField="project_code" >
            <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="300" />
        </asp:BoundField>
   ...
   <asp:Panel ID="search_panel" runat="server" CssClass="panelbackcolor">
    ...
    <table>
        <tr>
            ...
            <td style="padding-left:5%;"></td>
            <td><asp:ImageButton ID="btn_project_products" ToolTip="گزارش" runat="server" ImageUrl="~/images/Controls/report.png" PostBackUrl="~/Project/Project_Products.aspx"/></td>
        </tr>
    </table>
    <table>
        <tr>
