<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Opportunity.aspx.cs" Inherits="WebApplicationKartable.Opportunity1" %>
...
$(document).ready(function() {
	$('#progress').removeClass('running');	    
		$('.trigger').click(function() {
			$('#progress').removeClass('running').delay(2).queue(function(next){
...
$(document).ready(function() {
	$('#content').removeClass('fullwidth');	    
		$('.triggerFull').click(function() {
			$('#content').removeClass('fullwidth').delay(2).queue(function(next){
...
$(document).ready(function() {
	$('#loadbar').removeClass('ins');	    
		$('.triggerBar').click(function() {
			$('#loadbar').removeClass('ins').delay(2).queue(function(next){
				$(this).addClass('ins');
		        next();
		    });
		    return false;
...
<asp:Button runat="server" Text="انتقال سفارشات به نمایشگاه" ID="btn_transfer" OnClick="btn_transfer_Click"  CssClass="btn btn-primary" />
