<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="location.aspx.cs" Inherits="WebApplicationKartable.location" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="text-align:center;"><h2>محل برگزاری</h2></div>
       ...
       <Columns>
        ...
        <asp:TemplateField ItemStyle-Width = "300px"  HeaderText = "عنوان">
            ...
            <FooterTemplate>
                <asp:TextBox ID="txt_location_add" Width = "300px" MaxLength = "30" runat="server" CssClass="textbox"></asp:TextBox>
            </FooterTemplate> 
        </asp:TemplateField> 
        <asp:TemplateField>
            <ItemTemplate>
