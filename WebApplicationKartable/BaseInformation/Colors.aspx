<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Colors.aspx.cs" Inherits="WebApplicationKartable.Colors" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div style="text-align:center;"><h2>رنگ</h2></div>
       ...
       <Columns>
        ...
        <asp:TemplateField ItemStyle-Width = "300px"  HeaderText = "عنوان">
            <ItemTemplate>
                <asp:Label ID="lbl_color_name" runat="server" Text='<%# Eval("color_name")%>'></asp:Label>
            </ItemTemplate> 
            <EditItemTemplate>
                <asp:TextBox ID="txt_color_name" runat="server" Text='<%# Eval("color_name")%>'></asp:TextBox>
            </EditItemTemplate>  
            <FooterTemplate>
                <asp:TextBox ID="txt_color_name_add" Width = "300px" MaxLength = "30" runat="server" CssClass="textbox"></asp:TextBox>
            </FooterTemplate> 
        </asp:TemplateField> 
        <asp:TemplateField>
            <ItemTemplate>
