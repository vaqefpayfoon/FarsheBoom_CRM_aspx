...
namespace WebApplicationKartable
{
    public partial class Opportunity : System.Web.UI.Page
    {
        ...
        {
            string strQuery = "SELECT srl, meet_title FROM dbo.bas_sale_opportunity";
        ...
        protected void AddNewCustomer(object sender, EventArgs e)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "insert into bas_sale_opportunity(srl,meet_title) " +
            "values(@srl,@meet_title);" +
             "SELECT srl, meet_title FROM dbo.bas_sale_opportunity";
        ...
        protected void DeleteCustomer(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "delete from bas_sale_opportunity where " +
                "srl=@srl;" +
                "SELECT srl, meet_title FROM dbo.bas_sale_opportunity";
        ...
        protected void UpdateCustomer(object sender, GridViewUpdateEventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "update bas_sale_opportunity set meet_title=@meet_title " +
             "where srl=@srl;" +
             "Select srl,meet_title From dbo.bas_sale_opportunity";
        ...
        private int max_srl()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "SELECT ISNULL((MAX(srl) + 1),1) FROM dbo.bas_sale_opportunity";
