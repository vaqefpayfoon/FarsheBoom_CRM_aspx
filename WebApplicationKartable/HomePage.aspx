                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <asp:LinkButton ID="lnk_opportunity_sale" runat="server" Enabled="false" PostBackUrl="~/Project/Opportunity_Managment.aspx">انتقال فرصت فروش</asp:LinkButton></li>
                                    <li>
                            ...
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li>
                                        <asp:LinkButton ID="lnk_label" runat="server" Enabled="false" PostBackUrl="~/Project/LabelGenerator.aspx">چاپ برچسب</asp:LinkButton></li>
                                    <li>
                    ...
                    <section class="content">
                        <div class="row">
                            <div class="col-lg-3 col-xs-6">
                                <asp:LinkButton ID="box_supcust" runat="server" Enabled="false" PostBackUrl="~/Provider_Goods/Pricing.aspx" CssClass="small-box-footer">
                            ...
                            <div class="col-lg-3 col-xs-6">
                                <asp:LinkButton ID="box_provider" runat="server" Enabled="false" PostBackUrl="~/Project/MainCallBack.aspx" CssClass="small-box-footer">
                            ...
                            <div class="col-lg-3 col-xs-6">
                                <asp:LinkButton ID="box_opportunity" runat="server" Enabled="false" PostBackUrl="~/Project/Settelment.aspx" CssClass="small-box-footer">
