...
<asp:SqlDataSource ID="source_project" runat="server" ConnectionString="<%$ ConnectionStrings:FarsheBoom %>" SelectCommand="SELECT srl, project_code FROM dbo.bas_project order by srl desc"/>
    ...
    <tr>
        <td>تامین کننده :</td>
            ...
            <td><asp:Button ID="btn_without_price" runat="server" CssClass="btn-facebook" OnClick="btn_without_price_Click" Text="بدون قیمت ها" /></td>
            <td><asp:Button ID="btn_with_price" runat="server" CssClass="btn-facebook" OnClick="btn_with_price_Click" Text="تمام فرش ها" /></td>
        </tr>
        <tr style="border-color:navy;border-width:2px;">
            <td> تمام تامین کننده ها:</td>
            <td></td>
            <td><asp:Button ID="btn_load_without_price" runat="server" CssClass="btn-facebook" Text="بدون قیمت ها" OnClick="btn_load_without_price_Click"/></td>
            <td><asp:Button ID="btn_cache_all_data" runat="server" CssClass="btn-facebook" Text="تمام فرش ها" OnClick="btn_cache_all_data_Click"/></td>
        </tr>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>مساحت :</td>
            <td><asp:TextBox ID="txt_area" runat="server" CssClass="textbox"  Width="150px" ReadOnly="true"></asp:TextBox></td>
        </tr> 
        <tr>
            <td>کد فرش بوم :</td>
            ...
            <td><asp:TextBox ID="txt_pcode" runat="server" CssClass="textbox"  Width="150px"   MaxLength="100"></asp:TextBox><asp:Label ID="Label2" Text="*"  runat="server"></asp:Label>
        ...
        <td><asp:DropDownList ID="lst_raj" runat="server" CssClass="dropdown1"  Width="150px" DataSourceID="source_raj" DataTextField="raj_title" DataValueField="srl"></asp:DropDownList></td>
            <td>تاریخ :</td>
            <td><asp:TextBox ID="txt_u_date_time" runat="server" CssClass="textbox"  Width="150px" ReadOnly="true"></asp:TextBox></td>
        </tr>
            <tr>
                <td>نمایش در سایت</td>
                <td><asp:CheckBox ID="chk_choose" runat="server" Checked="false" ></asp:CheckBox></td>
            </tr>
    </table>
            </td>
            <td>
    ...
    <asp:Panel ID="Panel1" runat="server" CssClass="panelbackcolor">
            <table>
                <tr>
            <td><asp:Button ID="ImageButton_save" runat="server" CssClass="btn-facebook" Text="ذخیره فرش" OnClick="ImageButton_save_Click" ValidationGroup="RegisterUserValidationGroup2" /></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td><asp:Button AccessKey="n" ID="btn_next" runat="server" CssClass="btn-facebook" Font-Names="Tahoma" Font-Size="16" Text="<<" OnClick="btn_next_ServerClick" ToolTip="فرش بعدی" /></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td><asp:Button  AccessKey="p" ID="btn_previouse" runat="server" CssClass="btn-facebook" Font-Names="Tahoma" Font-Size="16" Text=">>" OnClick="btn_previous_ServerClick" ToolTip="فرش قبلی" /></td>
                </tr> 
            </table>
        </asp:Panel>
    <hr />
        ...
        <tr>
            <td style="width:35%;">
                <table>
                 <tr>
                    <td>مبلغ خرید :</td>
                    <td><asp:TextBox ID="txt_buy" runat="server" CssClass="textbox"  Width="150px" MaxLength="12"></asp:TextBox></td>
                </tr>
                <tr>
                <td>مبلغ فروش :</td>
                <td><asp:TextBox ID="txt_sell" runat="server" CssClass="textbox"  Width="150px" MaxLength="12"></asp:TextBox></td>
                </tr>
                 <tr>
                    <td>تخفیف واحد :</td>
            ...
            <td style="width:30%;padding-right:7%">
                <table>
                    <tr>
                        <td><p><asp:Label ID="lbl_project_goods" runat="server" CssClass="text-blue">
                            </asp:Label></p></td>   
                    </tr>
                    <tr>
                        <td><asp:DropDownList ID="lst_project" runat="server" CssClass="dropdown1"  Width="150px" DataSourceID="source_project" DataTextField="project_code" DataValueField="srl"></asp:DropDownList></td>
                    </tr>
                    <tr>
            ...
            <td style="width:35%;padding-right:7%">
                <table>
                    <tr>
                        <td><asp:Label ID="lbl_Margin" runat="server" CssClass="text-blue"></asp:Label></td>          
                    </tr>
                    <tr>
                        <td><asp:Label ID="lbl_UnitMargin" runat="server" CssClass="text-blue"></asp:Label></td>
                    </tr>
                    <tr>
