...
<asp:Panel ID="Panel_grid" runat="server" CssClass="panelbackcolor">
    <table>       
        <tr>
            ...
            <td>تا تاریخ :</td>
            <td><pdc:PersianDateTextBox ID="txt_to_date" runat="server"  IconUrl="~/images/Calendar.gif" SetDefaultDateOnEvent="OnClick" Width="200px" CssClass="textbox"></pdc:PersianDateTextBox></td>
        </tr>
        <tr>
        <td>انتخاب نمایشگاه :</td>
        <td><asp:DropDownList ID="lst_project" runat="server" CssClass="dropdown1"  Width="180px"></asp:DropDownList></td>
        <td>تامین کننده :</td>
    ...
    <table>
        <tr>
            <td><asp:ImageButton ID="ImageButton_Report" ToolTip="گزارش" runat="server" ImageUrl="~/images/Controls/Report.png" OnClick="btn_filter_Click"/></td>
            <td><asp:ImageButton ID="ImageButton_print" ToolTip="چاپ" runat="server" ImageUrl="~/images/Controls/Print.png" PostBackUrl="~/Project/Financial.aspx"/></td>
            <td><asp:ImageButton ID="imaged_product" ToolTip="چاپ عکس دار" runat="server" ImageUrl="~/images/Controls/Print.png" OnClick="imaged_product_Click"/></td>
        </tr>
    </table>
</asp:Panel>
<br /><hr />
<table>
    <tr>
        <td>تعداد :</td>
        <td><asp:TextBox ID="txt_sum" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
        <td>مجموع خرید :</td>
        <td><asp:TextBox ID="txt_buy" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
    </tr>
    <tr>
        <td>قیمت نمایشگاه</td>
        <td><asp:TextBox ID="txt_final_price" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
        <td>مجموع تخفیف :</td>
        <td><asp:TextBox ID="txt_total_discount" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
    </tr>
    <tr>
        <td>حاشیه سود</td>
        <td><asp:TextBox ID="txt_margin" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
        <td>سود نهایی :</td>
        <td><asp:TextBox ID="txt_profit" runat="server" CssClass="textbox" BackColor="LightSteelBlue" Width="180px" ReadOnly="true"></asp:TextBox></td>
    </tr>
</table>
<br /><hr />
